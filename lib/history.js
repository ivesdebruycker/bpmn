 ...
 * @constructor
 */
var HistoryEntry = exports.HistoryEntry = function(name, type, begin, end, data) {
    this.name = name;
    this.type = type;
...
var BPMNProcessHistory = exports.BPMNProcessHistory = function(history) {
    ...
    if (history) {
        this.historyEntries = history.historyEntries.map(function(historyEntry) {
            var entry = new HistoryEntry(historyEntry.name, historyEntry.type, historyEntry.begin, historyEntry.end, historyEntry.data);
